...
app.add_url_rule('/tools/cloud', view_func=routes.CloudView.as_view('cloud'))
app.add_url_rule('/tools/cloud-admin', view_func=routes.CloudAdminView.as_view('cloud_admin'))
